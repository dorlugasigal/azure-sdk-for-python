...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "CloudConfig": (".models.config", "CloudConfig"),
    "Config": (".models.config", "Config"),
    "ConnectionConfig": (".models.config", "ConnectionConfig"),
    "DatasetConfig": (".models.config", "DatasetConfig"),
    "EvaluatorConfig": (".models.config", "EvaluatorConfig"),
    "TargetVariantConfig": (".models.config", "TargetVariantConfig"),
    ...
    "EvaluationExecutor": (".evaluation.evaluation_executor", "EvaluationExecutor"),
    ...
    "AggregatedEvaluators": (".evaluation.evaluators_aggregator", "AggregatedEvaluators"),
    "EvaluatorsAggregator": (".evaluation.evaluators_aggregator", "EvaluatorsAggregator"),
